...
**CHANGELOG (post-produzione, 2026-07-23)**: (1) P6 "bugia di Leland sui propri spostamenti a Missoula" = **DEPRECATED** — il nodo repo reale (`leland_dove` [P]) contiene il racconto falso della PARTENZA DI MADDY («le ho chiamato io il taxi»); P6 canonica = T_LELAND_TAXI [P] + D_TAXI [N→L] (M9-M10 v1.1.1). (2) [L SUPERSEDED] momento-torta → scena degli orari della corriera (M8 v1.1). (3) [L] «Laura è l'ultima immagine della LOGGIA; Twin Peaks all'alba è l'ultima immagine del GIOCO» (chiarimento del lock §13). (4) L'ordine degli incontri nella Loggia riguarda Nano e BOB (due ordini); Laura è sempre terza.
