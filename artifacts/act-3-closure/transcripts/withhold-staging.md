# Atto 3 — trascrizione giocata «withhold-staging»
...
- **scelta presa**: `first_staging`
- `m5.b8b.feedback.first_staging` [m5_theory_first] _(scena)_ — (Cooper scrive la riga a penna.)
- _stato_: {"values":{"m5_final_theory":"staging"}}
...
- `m5.b9.report.theory_staging` [m5_report_intro] **COOPER** — Il centro è stato lasciato così perché venisse letto. Lo firmo io, Harry.
- `m5.b9.report.accept.p01` [m5_report_intro] **TRUMAN** — La lettura la verbalizziamo come tua. I fatti come nostri.
...
- _obiettivo (dopo l'interazione)_: One Eyed Jacks: siediti al tavolo di Jacques Renault.
- **scelta presa**: `tactic_pressione`
- `m6.b5.pressione.p01` [m6_interrogation_pressione] **COOPER** — (resta in piedi) Jacques Renault. Stanotte dormi dal lato giusto del fiume. Quanto comoda sarà la cella, dipende dai prossimi due minuti.
- `m6.b5.pressione.p02` [m6_interrogation_pressione] **JACQUES** — (alza le mani, ride male) Piano, agente. Piano. Quella notte al vagone c'ero, sì — ma c'era mezzo mondo.
- `m6.b5.pressione.q1` [m6_interrogation_pressione] **COOPER** — I nomi del mezzo mondo. Adesso.
- `m6.b5.pressione.p04` [m6_interrogation_pressione] **JACQUES** — Il camionista della birra, quello del Roadhouse. Il barista, quello nuovo. Un ragazzo del paese che non nomino — ha una madre. E quello dei fiammiferi.
- `m6.b5.pressione.p05` [m6_interrogation_pressione] _(scena)_ — (Sulla parola "fiammiferi" la voce cala. Le mani smettono di muoversi.)
- `m6.b5.pressione.p06` [m6_interrogation_pressione] **COOPER** — Quello dei fiammiferi.
- `m6.b5.pressione.p07` [m6_interrogation_pressione] **JACQUES** — Uno che accendeva e spegneva. Accendeva e spegneva. Senza mai fumare.
- `m6.b5.pressione.q2` [m6_interrogation_pressione] **COOPER** — (seconda domanda) Chi dei quattro c'era QUELLA notte?
- `m6.b5.pressione.p09` [m6_interrogation_pressione] **JACQUES** — (le mani ferme) Quella notte... (si riprende) Quella notte io tenevo il banco e guardavo le carte. Le facce, chiedetele alle carte.
- _commit_ `m6_interrogation_pressione`
...
- _stato_: {"flags":["jacques_admitted_presence"],"evidence":["JACQUES_LIST_GIVEN"],"nodes_done":["m6_interrogation_pressione","m6_p5"]}
...
- `m6.b8.news.cooper_pressione` [m6_news] **COOPER** — Quattro nomi sul suo elenco, Harry. Sui fiammiferi ha abbassato la voce. Ora non posso chiedergli perché.
- _commit_ `m6_news`
