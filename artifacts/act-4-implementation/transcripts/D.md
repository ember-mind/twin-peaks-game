# Atto 4 — trascrizione giocata «D» (accompagno → avviso Palmer → focus lago; nessuna visita facoltativa (valigia per rapporto))
...
- `m8.f.station.p_valigia` [m8_station] **TRUMAN** — In ingresso c'era la valigia pronta, e un biglietto per Sarah. Voleva partire domattina.
