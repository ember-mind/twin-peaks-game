...
| diner → Roadhouse | norma, shelly, loglady, james | the Double R closes for the Roadhouse evening: `m8.b0.leland_taxi.chiusura.p01` (B1 closed) |
...
**READY FOR CAST PRESENCE IMPLEMENTATION** (amended 2026-09-11 after B1 closed by lead decision, option B; see `docs/cast-continuity-b1-resolution.md`). Everything in Acts 1–4 is internally consistent and mechanically compilable: Hawk, Truman, Jacques, Maddy, the Roadhouse exit, the Act 3 chain and now the diner regulars' departure are fixed from frozen or approved text. Previous verdict (superseded): NOT READY on B1.
