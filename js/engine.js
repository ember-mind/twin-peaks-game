...
(function () {
  ...
  function freshState() {
    return {
      ...
      player: { tx: 28, ty: 33, x: 28 * TILE, y: 33 * TILE, dir: 'up', moving: false, mx: 0, my: 0 },
      clues: [], flags: {},
      introPage: 0,
  ...
  function pressA() {
    ...
    if (S.mode === 'end') { S = E.state = freshState(); loadMap('town', 28, 33, 'up'); return; }
