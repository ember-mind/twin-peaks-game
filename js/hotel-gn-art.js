...
(function(){
  ...
  function guestRunner(R){
    /* One straight public arrival spine reaches the foot of the lounge at
     * y=116, stopping short of the authored chair/table footprint above. */
    var x=128,y=116,w=32,h=60;
    R(x,y,w,h,p.ink);
