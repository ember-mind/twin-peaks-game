...
(async function () {
  ...
  try {
    ...
    const stops = [['01-dawn-asleep', 1, 370, 'resident_a'], ['02-morning-park-bench-and-book', 1, 640, 'resident_d'], ['03-noon-cafe', 1, 780, 'resident_c'],
                   ['04-dusk-park-talking', 1, 1065, 'resident_a'], ['04b-evening-eating-at-a-table', 1, 1067, 'resident_e'], ['05-evening-cafe', 1, 1180, 'resident_c'], ['06-night-asleep', 1, 1400, 'resident_b']];
