...
assert(/var CAST_RENDERER = 'heartgold-atlas-r116'/.test(authored), 'HeartGold cast is production renderer');
assert(/if \(drawCastWalkSheet\(ctx, name/.test(authored), 'production atlas draws Cooper after load');

console.log('COOPER-SPRITE-PASS 10/10');
