...
const els={};function el(id){return els[id]||(els[id]={id,hidden:false,disabled:false,textContent:'',onclick:null,width:256,height:192,style:{setProperty:noop},getContext:()=>ctx,classList:{toggle:noop},_attrs:{},setAttribute(n,v){this._attrs[n]=v;},getAttribute(n){return n in this._attrs?this._attrs[n]:null;},removeAttribute(n){delete this._attrs[n];},addEventListener:noop});}
...
['tiles.js','chars.js','houses.js','maps.js','data.js','retro-font.js','portraits.js','gold-tone.js','engine.js','scene-objects.gen.js','glue.js','retro.js','retro-authored.js','retro-cast-matrices-a.js','retro-cast-matrices-b.js','ambient-life.js','character-activity.js','environment-reactions.js','ambient-life-scenes.js','location-connections.js'].forEach(js);
js('double-r-exterior-art.js');js('double-r-exterior-scene.js');js('world-connections.gen.js');require('./pages/double-r-location.js');
