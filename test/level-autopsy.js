...
// Interact keys live in the scene objects registry (world/scene-objects.json) since M8, not in js/maps.js.
const interact = JSON.parse(require('fs').readFileSync(require('path').join(__dirname,'..','world','scene-objects.json'),'utf8')).scenes.town.interact;
